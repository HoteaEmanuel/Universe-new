// Ported from frontend/src/features/chat/utils/chatListTime.ts — identical
// logic (pure Date/Intl, no DOM), kept as its own mobile copy rather than
// hoisted since chat is the only surface using it so far on either platform.
